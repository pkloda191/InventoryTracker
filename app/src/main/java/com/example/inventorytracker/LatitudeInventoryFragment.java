...
public class LatitudeInventoryFragment extends ListFragment
{
    ListView lv;
    View myView;
    @Nullable
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        Core.itemAdapterNameLocation = new ItemCustomArrayAdapterNameLocation(getActivity(), Core.latitudeList);
